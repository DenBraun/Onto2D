...
Case ID: `ltee-evolutionary-contingency`. [History case registry](../history-case-registry.json).

- [LTEE Evolutionary Contingency — use and reproduction](#ltee-evolutionary-contingency--use-and-reproduction)
- [LTEE Evolutionary Contingency — source and interpretation](#ltee-evolutionary-contingency--source-and-interpretation)

<a id="ltee-evolutionary-contingency--use-and-reproduction"></a>

## LTEE Evolutionary Contingency — use and reproduction
...
<a id="ltee-evolutionary-contingency--source-and-interpretation"></a>

## LTEE Evolutionary Contingency — source and interpretation

<a id="ltee-evolutionary-contingency--source-and-interpretation--result"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--exact-source-boundary"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--projection-and-arithmetic-checks"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--three-replay-protocols"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--reachability-semantics"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--identity-and-historical-boundaries"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--historical-load-candidate-and-current-boundary"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--case-artifact"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--model-pack"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--explorer"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--repository-outputs"></a>
...
cases/ltee-evolutionary-contingency/README.md
```
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--verification"></a>
...
<a id="ltee-evolutionary-contingency--source-and-interpretation--primary-source"></a>
