...
Case ID: `mineral-formation-history`. [History case registry](../history-case-registry.json).

- [Mineral Formation History — use and reproduction](#mineral-formation-history--use-and-reproduction)
- [Mineral Formation History — source and interpretation](#mineral-formation-history--source-and-interpretation)

<a id="mineral-formation-history--use-and-reproduction"></a>

## Mineral Formation History — use and reproduction
...
<a id="mineral-formation-history--use-and-reproduction--exact-sources"></a>
...
<a id="mineral-formation-history--use-and-reproduction--evidence-discipline"></a>
...
<a id="mineral-formation-history--use-and-reproduction--reproduce-and-verify"></a>
...
<a id="mineral-formation-history--source-and-interpretation"></a>

## Mineral Formation History — source and interpretation
...
<a id="mineral-formation-history--source-and-interpretation--result"></a>
...
<a id="mineral-formation-history--source-and-interpretation--source-lock"></a>
...
<a id="mineral-formation-history--source-and-interpretation--reviewed-formation-claims"></a>
...
<a id="mineral-formation-history--source-and-interpretation--evidence-layers"></a>
...
<a id="mineral-formation-history--source-and-interpretation--identity-regimes"></a>

### Identity Regimes

<a id="mineral-formation-history--source-and-interpretation--conventional-species"></a>

#### Conventional species

All ten samples form one bounded `Pyrite / FeS2` class.

<a id="mineral-formation-history--source-and-interpretation--sample-record"></a>

#### Sample record

The native sample IDs form ten distinct classes.

<a id="mineral-formation-history--source-and-interpretation--published-formation-profile"></a>
...
<a id="mineral-formation-history--source-and-interpretation--canonical-experiments"></a>
...
<a id="mineral-formation-history--source-and-interpretation--historical-load"></a>
...
<a id="mineral-formation-history--source-and-interpretation--model-pack"></a>
...
<a id="mineral-formation-history--source-and-interpretation--explorer"></a>
...
<a id="mineral-formation-history--source-and-interpretation--negative-guarantees"></a>
...
<a id="mineral-formation-history--source-and-interpretation--reproduce"></a>
...
<a id="mineral-formation-history--source-and-interpretation--falsification-criterion"></a>
