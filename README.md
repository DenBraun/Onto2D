...
A release still requires a green CI matrix and independent review of the
...
Research inputs and reproductions live in [`cases/`](cases). The current
Level-0 oscillator case freezes source identities only; the
[three-node-motif case](cases/three-node-motifs/README.md) is executable and
frozen.
