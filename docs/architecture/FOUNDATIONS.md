...
- [Foundations and scientific interpretation](#foundations-and-scientific-interpretation)

<a id="foundations-and-scientific-interpretation"></a>

## Foundations and scientific interpretation
...
<a id="foundations-and-scientific-interpretation--2-ontological-progression-in-the-paper"></a>
...
<a id="foundations-and-scientific-interpretation--21-alignment-with-the-existing-level-0json-catalogue"></a>
...
| `0.7`, `0.8` | Configurational Density and CRT-Node | C | The paper derives `Gamma` and objecthood before declaring Phase B complete on page 24 | Phase mismatch; require an explicit mapping policy, never silently rewrite source data |
...
<a id="foundations-and-scientific-interpretation--3-formal-claims-and-computational-disposition"></a>

### 3. Formal claims and computational disposition

<a id="foundations-and-scientific-interpretation--31-phase-a-distinguishability-and-compensation"></a>
...
<a id="foundations-and-scientific-interpretation--32-phase-b-oscillatory-admissibility"></a>
...
<a id="foundations-and-scientific-interpretation--33-phase-b-why-the-dyad-is-insufficient"></a>
...
<a id="foundations-and-scientific-interpretation--34-coherent-resonant-triad"></a>
...
<a id="foundations-and-scientific-interpretation--35-configurational-density-and-object-status"></a>
...
<a id="foundations-and-scientific-interpretation--36-phase-c-nonlinear-node-formalization"></a>
...
<a id="foundations-and-scientific-interpretation--37-phase-c-collective-admissibility"></a>
...
<a id="foundations-and-scientific-interpretation--38-completion-of-level-0"></a>
...
<a id="foundations-and-scientific-interpretation--39-phase-d-and-ensemble-quanta"></a>
...
<a id="foundations-and-scientific-interpretation--310-variational-selection"></a>
...
<a id="foundations-and-scientific-interpretation--311-transition-to-level-1"></a>
...
<a id="foundations-and-scientific-interpretation--4-kernel-requirements-implied-by-the-paper"></a>

### 4. Kernel requirements implied by the paper

The paper implies the following kernel requirements.

<a id="foundations-and-scientific-interpretation--41-three-coordinate-systems"></a>
...
<a id="foundations-and-scientific-interpretation--42-scientific-quantities-and-evidence"></a>
...
<a id="foundations-and-scientific-interpretation--43-cohort-selector"></a>
...
<a id="foundations-and-scientific-interpretation--44-external-computation-boundary"></a>
...
<a id="foundations-and-scientific-interpretation--45-richer-cycle-semantics"></a>
...
<a id="foundations-and-scientific-interpretation--46-carrier-promotion-and-profiles"></a>
...
<a id="foundations-and-scientific-interpretation--47-evidence-state-separation"></a>
...
<a id="foundations-and-scientific-interpretation--48-source-graph-condensation-and-joint-arising"></a>
...
<a id="foundations-and-scientific-interpretation--5-proposed-level-0-computational-ladder"></a>
...
<a id="foundations-and-scientific-interpretation--6-case-acceptance-matrix"></a>

### 6. Case acceptance matrix

<a id="foundations-and-scientific-interpretation--61-oscillatory-mode-gate"></a>
...
<a id="foundations-and-scientific-interpretation--62-dyad-versus-triad-gate"></a>
...
<a id="foundations-and-scientific-interpretation--63-crt-objecthood-gate"></a>
...
<a id="foundations-and-scientific-interpretation--64-ensemble-gate"></a>
...
<a id="foundations-and-scientific-interpretation--65-catalogue-scc-and-joint-arising-gate"></a>
...
<a id="foundations-and-scientific-interpretation--7-what-the-supplied-paper-does-not-specify-computationally"></a>
...
<a id="foundations-and-scientific-interpretation--8-claims-that-require-special-caution"></a>
...
<a id="foundations-and-scientific-interpretation--9-consequences-for-null-models"></a>
...
<a id="foundations-and-scientific-interpretation--10-final-architectural-interpretation"></a>
