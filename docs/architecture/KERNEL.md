...
- [Kernel model and boundaries](#kernel-model-and-boundaries)

<a id="kernel-model-and-boundaries"></a>

## Kernel model and boundaries
...
thematic [architecture contracts](../README.md).

<a id="kernel-model-and-boundaries--purpose"></a>
...
<a id="kernel-model-and-boundaries--scope"></a>
...
see [Onto2D Engine Architecture](ENGINE.md#engine-and-model-pack-architecture).

<a id="kernel-model-and-boundaries--dependency-rule"></a>
...
<a id="kernel-model-and-boundaries--core-model"></a>

### Core model

<a id="kernel-model-and-boundaries--element"></a>
...
<a id="kernel-model-and-boundaries--profile"></a>
...
<a id="kernel-model-and-boundaries--candidate"></a>
...
<a id="kernel-model-and-boundaries--package-and-run"></a>
...
<a id="kernel-model-and-boundaries--identity-and-canonicalization"></a>
...
<a id="kernel-model-and-boundaries--execution-pipeline"></a>
...
<a id="kernel-model-and-boundaries--predicate-and-numeric-semantics"></a>
...
<a id="kernel-model-and-boundaries--finite-execution-and-pruning"></a>
...
<a id="kernel-model-and-boundaries--selection-and-closure"></a>
...
<a id="kernel-model-and-boundaries--null-models"></a>
...
<a id="kernel-model-and-boundaries--source-migration"></a>
...
<a id="kernel-model-and-boundaries--artifacts-and-persistence"></a>
...
<a id="kernel-model-and-boundaries--security-and-resource-isolation"></a>
...
<a id="kernel-model-and-boundaries--conformance"></a>
...
See [Implementation Status](../ROADMAP.md) for the current
boundary and [Review Guide](../DEVELOPMENT.md) for review order.
