...
export function validateRetinalPilot({ graph, migration, pilot, pilotPolicy }, legacy, { sources, claims, entities, relations }) {
  ...
  assert.equal(studies.size, pilot.studies.length, "Duplicate pilot study");
